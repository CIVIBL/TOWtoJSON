...
//
//   node scripts/build-nr-data.mjs [--src <dir>] [--faction <slug>]... [--fresh]
//
// Without --src the repo is shallow-cloned to a temp dir (reused if present;
// --fresh forces a re-clone to pick up upstream changes). Default: every
// catalogue in CATALOGUE_MAP.
//
...
if (!srcDir) {
  ...
  if (args.includes('--fresh') && existsSync(srcDir)) {
    console.log(`--fresh: removing cached clone at ${srcDir}`);
...
function buildFactionData(slug) {
  ...
  return {
    __source: { repo: REPO_URL, file, retrievedAt: RETRIEVED_AT, note: 'Generated by scripts/build-nr-data.mjs — do not edit by hand.' },
    catalogueId: cat.id,
...
const gameSystem = {
  __source: { repo: REPO_URL, file: gst.file, retrievedAt: RETRIEVED_AT, note: 'Generated by scripts/build-nr-data.mjs — do not edit by hand.' },
  gameSystemId: gst.id,
...
function stampNote() {
  return { repo: REPO_URL, retrievedAt: RETRIEVED_AT, note: 'Generated by scripts/build-nr-data.mjs — do not edit by hand.' };
}
